...
@section('main-content')
    <div class="row">
        <div class="col-md-12" style="margin-bottom:3%">
            ...
            <h1 style="font-family:auto;color:#333;display:inline;">DANH SÁCH QUẢN TRỊ VIÊN ĐÃ XÓA</h1>
        </div>
        <div class="col-md-12">
